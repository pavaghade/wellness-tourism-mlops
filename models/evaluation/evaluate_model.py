...
class ModelEvaluator:
    ...
    def load_model_and_data(self):
        ...
        model = None
        try:
            print(f"Downloading model from: {self.model_repo_name}")
            ...
            try:
                ...
                raise Exception(f"Model not found! Error: {e2}")
        
        test_df = None
        try:
            print(f"Trying to load test data from Hugging Face...")
            ...
            try:
                ...
                raise Exception(f"Test data not found! Error: {e2}")
